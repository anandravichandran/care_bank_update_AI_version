...
//     color: "amber",
//     description: "Hello! I'm your Budget Planner. How can I help you manage your finances today?",
//     initialMessage: "Hi, I am your Budget Planner. Ask me about budget allocation, spending patterns, or get personalized recommendations.",
//     buildReply: function(query, transactions) {
...
//     initialMessage: "Hi, I am your Expense Tracker. Ask me about your spending patterns, recent transactions, or get alerts.",
//     buildReply: function(query, transactions) {
//       const q = query.toLowerCase();
...
//       if (transactions.length === 0) {
//         return { text: "No transactions tracked yet. Import your data to start tracking expenses.", mood: "concerned" };
//       }
...
//     initialMessage: "Hi, I am your Savings Optimizer. Ask me about savings goals, optimization strategies, or get personalized tips.",
//     buildReply: function(query, transactions) {
//       const q = query.toLowerCase();
...
// function buildAgentReply(agentId, query, transactions) {
//   const agent = AGENTS[agentId];
//   if (!agent) return { text: "Agent not found.", mood: "idle" };
//   return agent.buildReply(query, transactions);
// }
...
//       setMood("thinking");
//       setTimeout(() => {
//         const { text: reply, mood: replyMood } = buildAgentReply(selectedAgent, text, transactions);
//         streamText(reply, replyMood);
//         speak(reply);
//       }, 700 + Math.random() * 500);
//     }, 350);
//   }
...
//       <div className="absolute top-[650px] left-0 right-[80px] z-5 flex flex-col items-center pointer-events-none" style={{ paddingTop: "10px" }}>
...
//           <button
//             type="submit"
//             className="shrink-0 w-9 h-9 rounded-full bg-amber-500 hover:bg-amber-400 text-void-950 flex items-center justify-center transition-colors"
...
const AGENTS = {
  budget: {
    ...
    // Build local fallback reply (used when API is unavailable)
          ...
          {isLoading && (
            <div className="flex justify-start w-full">
              <div className="rounded-lg px-4 py-2.5 bg-void-800/80 backdrop-blur-sm border border-void-600/40 text-bone/90 mr-auto">
                ...
                <span className="inline-block w-1 h-3 bg-amber-400 ml-1 align-middle animate-pulseSoft" />
              </div>
            </div>
          )}
        </div>
